...
function displayOtherLocations()
{
    ...
    //alert("other locations = " + JSON.stringify(locationWeatherCache.toJSON()))
    ...
    for (var i = 0; i < n; i++)
    {
        ...
        //document.getElementById("textArea").value = document.getElementById("textArea").value + " +++++ " + JSON.stringify(loc);

        //alert("location key is " + key + " this location = " + JSON.stringify(loc));
        ...
        if (loc.forecasts.hasOwnProperty(key)) {
            ...
            //document.getElementById("textArea").value = document.getElementById("textArea").value + " +++++ " + JSON.stringify(forecast);

            //alert("Forecast summary = " + forecast.summary);
...
function getCurrentLocationAndWeatherInformation() {
    ...
    currentLocationWeatherCache.getCurrentLocationByGeocode(currentLocationAddress, errorLocation);
}
...
function currentLocationAddress(position) {
    ...
    //alert("Response current position longitude is = " + JSON.stringify(position.coords.longitude));
...
function getCurrentForecast(date, forecast) {
    ...
    //it is time to display other locations
